  ...
  return (
    <section className="w-full bg-[#0a0a0a] flex flex-col items-center pt-[40px] pb-[100px] overflow-hidden">
      ...
      <div className="w-full max-w-[1800px] flex flex-col items-center px-4 relative">
        ...
        {/* Main Hero Card */}
        <div className="relative w-full max-w-[1646px] bg-white rounded-[20px] p-6 sm:p-8 lg:p-0 lg:pt-[60px] 2xl:pt-[85px] lg:pb-[30px] flex flex-col items-center shadow-2xl overflow-hidden">
          
          <h2 className="text-[22px] sm:text-[26px] lg:text-[32px] xl:text-[40px] 2xl:text-[44px] font-bold text-black text-center uppercase tracking-tight lg:tracking-wide leading-[1.1] lg:leading-normal px-2 lg:px-4">
            SEE YOUR FINISHED<br className="sm:hidden" /> WATCH WEBSITE<br className="sm:hidden" /> BEFORE YOU <span className="text-[#d33a3a]">PAY A CENT</span>
          </h2>
          <p className="mt-2 lg:mt-[15px] text-[14px] sm:text-[15px] lg:text-[20px] xl:text-[22px] 2xl:text-[29px] font-medium text-black/80 text-center w-full px-4 max-w-[320px] sm:max-w-none lg:whitespace-nowrap leading-[1.4] lg:leading-normal">
            The website system built specifically for independent watch brands and boutique retailers
          </p>

          {/* Desktop: Relative container for image & animated floating badges */}
          <div className="hidden lg:block relative w-[1584px] h-[406px] mt-[34px] origin-top scale-[0.7] xl:scale-[0.85] 2xl:scale-100 transition-transform duration-300">
            {/* Central Image */}
          ...
          {/* Mobile: Image + stacked badges */}
          <div className="flex flex-col items-center w-full lg:hidden gap-6 mt-6">
